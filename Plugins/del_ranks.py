...
_DEL_RANKS_EXACT = frozenset(['مسح الادمن', 'مسح الادمنيه', 'مسح المالكين', 'مسح المالكين الاساسيين', 'مسح المحظورين عام', 'مسح المدراء', 'مسح المكتومين', 'مسح المكتومين عام', 'مسح المميزين', 'مسح قائمه Dev', 'مسح قائمه MY'])
_DEL_RANKS_PREFIXES = ()
...
def delRanksHandler(c,m):
   ...
   if not matches_command(routed_text, _DEL_RANKS_EXACT, _DEL_RANKS_PREFIXES):
      return False
   k = r.get(f'{Dev_Zaid}:botkey')
   return del_ranks_func(c,m,k)
